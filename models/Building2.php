...
class Building2 extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'tumbon' => 'ตำบล',
            'rank_cup' => 'ลำดับCUP',
            'rank_sso' => 'ลำดับกลุ่ม สสอ.',
            'rank_hos' => 'ลำดับกลุ่ม ผอ.รพ.',
            'rank_CR' => 'ลำดับระดับจังหวัด',
            'b_list' => 'รายการครุภัณฑ์',
            ...
            'hos_lev' => 'ระดับสถานบริการ SP',
            't_build' => 'ประเภทคำขอ',
            'reason' => 'เหตุผลที่ขอ (กรณีทดแทน หรือ เพิ่มเติมควรระบุเลขครุภัณฑ์ในนี้',
